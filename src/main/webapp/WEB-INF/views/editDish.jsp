                ...
                <div id="user_register" class="box-content">
                    ...
                    <form action="edit" method="Post" autocomplete="off">
                        <div class="input-block">
                            <label>Name</label></br>
                            <input type="text" name="name" value="${info.name}" class="input-area"  placeholder=""><br/>
                        </div>
                        <div class="input-block">
                            <label>Category</label></br>
                            <input name="category_id" value="${info.category_id}" class="input-area" id="password" placeholder=""/></br>
                        </div>
                        <div class="input-block">
                            <label>Description</label></br>
                            <input type="text" name="description" value="${info.description}" class="input-area"  placeholder=""><br/>
                        </div>
                        <div class="input-block">
                            <label>Price</label></br>
                            <input type="text" name="price" value="${info.price}" class="input-area"  placeholder=""><br/>
                        </div>
